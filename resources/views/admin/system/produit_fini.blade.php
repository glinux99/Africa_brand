...
<div class="aiz-main-content">
    <div class="px-15px px-lg-25px">
        ...
        <div class="aiz-titlebar text-left mt-2 mb-3">
            <h5 class="mb-0 h6">@lang("Ajouter une nouvelle matiere premiere")</h5>
        </div>
        <div class="">
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0 h6">@lang("Information sur la matiere premiere")</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">@lang("Designation") <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">@lang("Type d'embalage")</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="unite" placeholder="Unit (e.g. KG, Pc etc)" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">@lang("Unite par defaut")</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="unite" placeholder="Unit (e.g. KG, Pc etc)" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">@lang("Sous compte") <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="name" placeholder="@lang(' Nom du produit')" onchange="update_sku()" required>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0 h6">@lang("Description de la matiere premiere")</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group row">
